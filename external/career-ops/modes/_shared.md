...
|-----------|---------------|---------------|
| **Senior Backend Engineer** | APIs, distributed systems, reliability, performance | Someone who ships robust services at scale |
| **Staff / Principal Engineer** | Technical leadership, architecture, cross-team influence | Someone who raises the bar across engineering |
| **Platform / Infrastructure Engineer** | Developer tooling, internal platforms, reliability, IaC | Someone who makes other engineers faster |
| **Backend Tech Lead** | System design, delivery, mentorship, stakeholder alignment | Someone who owns a domain end-to-end |
| **Distributed Systems Engineer** | Messaging, consistency, fault tolerance, data pipelines | Someone who tames complexity at scale |
| **Engineering Manager (IC→EM)** | People, delivery, roadmap, hiring | Someone who multiplies team output |
...
|-------------------|----------------------------------|---------------------|
| Senior Backend Engineer | Scalable APIs, reliability track record, ownership, latency wins | article-digest.md + cv.md |
| Staff / Principal | Architectural decisions, cross-team impact, technical strategy | article-digest.md + cv.md |
| Platform / Infra | Internal tooling built, deploy velocity improved, SLOs owned | article-digest.md + cv.md |
| Backend Tech Lead | Delivery ownership, mentorship, design docs shipped | cv.md + article-digest.md |
| Distributed Systems | Throughput/latency numbers, consistency trade-offs, on-call | article-digest.md + cv.md |
| Engineering Manager | Team growth, retention, roadmap delivered, hiring bar raised | cv.md + article-digest.md |
...
- For Senior BE: "builder who ships reliable systems with observable, measurable outcomes"
- For Staff/Principal: "builder who changes how a team works, not just what they ship"
- For Platform: "builder who turns pain points into leverage for other engineers"
- For Tech Lead: "builder who owns the domain, not just the tickets"
